...
_XARM_WITH_SPOON_INSTANCEABLE_USD = "/home/aman/.local/share/ov/pkg/isaac_sim-2022.2.0/arcare/asset/robots/xarm_without_gripper/xarm7_spoon.usd"
...
XARM_ARM_WITH_SPOON_CFG = SingleArmManipulatorCfg(
    ...
    ee_info=SingleArmManipulatorCfg.EndEffectorFrameCfg(
        ...
        body_name="link_eef", pos_offset=(0.0, 0.0, 0.175), rot_offset=(1.0, 0.0, 0.0, 0.0)
    ),
    actuator_groups={
